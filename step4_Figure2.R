...
DimPlot(NPC.tmp,group.by = "Annotation.Epi",reduction = "umap")
...
Autophagy <- c("ATG5","ATG7","ATG12","MAP1LC3A","MAP1LC3B","BECN1","HIF1A","FIS1")
...
#FeaturePlot(NPC.tmp, features="score.EMT")

#plot(NPC.tmp@meta.data$score.E_EMT1,
#     NPC.tmp@meta.data$score.M_EMT1,
#     #xlim = c(1,0),
#     col = factor(levels(factor(NPC.tmp@meta.data$infercnv))),
#     pch = 20)
...
#FeaturePlot(NPC.tmp, features="score.Hypoxia1")

###############################################################
# Lipid Metabolism
NPC.tmp <- AddModuleScore(object = NPC.tmp,features = list(Lipid_Metabolism),ctrl = 100,name = "score.Lipid_Metabolism")
#FeaturePlot(NPC.tmp, features="score.Lipid_Metabolism1")

###############################################################
# Mitochondrion
NPC.tmp <- AddModuleScore(object = NPC.tmp,features = list(Mitochondrion),ctrl = 100,name = "score.Mitochondrion")
#FeaturePlot(NPC.tmp, features="score.Mitochondrion1")

###############################################################
# CSC
NPC.tmp <- AddModuleScore(object = NPC.tmp,features = list(CSC),ctrl = 100,name = "score.CSC")
#FeaturePlot(NPC.tmp, features="score.CSC1")

###############################################################
# Autophagy
NPC.tmp <- AddModuleScore(object = NPC.tmp,features = list(Autophagy),ctrl = 100,name = "score.Autophagy")
#FeaturePlot(NPC.tmp, features="score.Autophagy1")

###############################################################
# MHC
NPC.tmp <- AddModuleScore(object = NPC.tmp,features = list(MHC),ctrl = 100,name = "score.MHC")
#FeaturePlot(NPC.tmp, features="score.MHC1")




#NPC.tmp@meta.data$Stemness <- "Tumor"
#NPC.tmp@meta.data$Stemness[tail(order(NPC.tmp@meta.data$CytoTRACE),100)] <- "Stem-like Tumor"
# NPC.tmp@meta.data$Stemness <- "Tumor"
# a <- order(NPC.tmp@meta.data$CytoTRACE)
# NPC.tmp@meta.data$Stemness[tail(a,100)] <- "Stem-like Tumor"
#NPC.tmp@meta.data$Stemness[head(a,100)] <- "Stem-like Tumor"
# VlnPlot(NPC.tmp, features = c("score.EMT"),group.by = "Stemness")



#cov_EMT <- cov(NPC.tmp@meta.data$CytoTRACE,NPC.tmp@meta.data$score.EMT,method = 'pearson')
#cov_Hypoxia <- cov(NPC.tmp@meta.data$CytoTRACE,NPC.tmp@meta.data$score.Hypoxia1,method = 'pearson')
#cov_Lipid_Metabolism <- cov(NPC.tmp@meta.data$CytoTRACE,NPC.tmp@meta.data$score.Lipid_Metabolism1,method = 'pearson')
#cov_Mitochondrion <- cov(NPC.tmp@meta.data$CytoTRACE,NPC.tmp@meta.data$score.Mitochondrion1,method = 'pearson')
#cov_CSC <- cov(NPC.tmp@meta.data$CytoTRACE,NPC.tmp@meta.data$score.CSC1,method = 'pearson')
#cov_Autophagy <- cov(NPC.tmp@meta.data$CytoTRACE,NPC.tmp@meta.data$score.Autophagy1,method = 'pearson')
...
NPC.figure <- NPC.tmp
NPC.figure@meta.data$stemness<- NPC.tmp@meta.data$CytoTRACE
NPC.figure@meta.data$E.EMT <- NPC.figure@meta.data$score.E_EMT
NPC.figure@meta.data$M.EMT <- NPC.figure@meta.data$score.M_EMT
NPC.figure@meta.data$EMT <- NPC.figure@meta.data$score.EMT
NPC.figure@meta.data$Hypoxia <- NPC.figure@meta.data$score.Hypoxia1
NPC.figure@meta.data$Lipid_Metabolism <- NPC.figure@meta.data$score.Lipid_Metabolism1
NPC.figure@meta.data$Mitochondrion <- NPC.figure@meta.data$score.Mitochondrion1
NPC.figure@meta.data$CSC <- NPC.figure@meta.data$score.CSC1
NPC.figure@meta.data$Autophagy <- NPC.figure@meta.data$score.Autophagy1
NPC.figure@meta.data$MHC <- NPC.figure@meta.data$score.MHC1

#markers <- c("Stemness","E.EMT","M.EMT","EMT","Hypoxia","Lipid_Metabolism","Mitochondrion","CSC","Autophagy")
...
NPC.sc <- subset(NPC.figure, subset = orig.ident %in% c("N01","N02","P01","P02","P03"))
NPC.sn <- subset(NPC.figure, subset = orig.ident %in% c("N03","P04","P05","P06","P07"))
